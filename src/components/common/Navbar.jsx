      ...
      <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-1 md:space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {/* Shop link with icon - External link */}
            <a 
              href="https://www.jkapp.pro/shop"
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-3 space-y-1">
              ...
              {/* Shop link - External link */}
              <a
                href="https://www.jkapp.pro/shop"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center px-4 py-2 rounded-md text-base font-medium transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
