          ...
          <div className="md:col-span-2 flex justify-center order-2 md:order-1">
            <div className="relative">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 overflow-hidden rounded-full border-4 border-white dark:border-gray-800 shadow-xl">
                <img 
                  src="/jkdp.png"
                  alt="Kimutai Joel Professional Portrait"
          ...
          <div className="md:col-span-3 order-1 md:order-2">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-300 mb-8">
              <p className="leading-relaxed">
                I'm a passionate Software Engineer with expertise in building responsive web applications, RESTful APIs, 
                and cloud infrastructure. With {experienceYears} years of experience, I've developed a strong foundation 
                in both frontend and backend technologies.
              </p>
              <p className="leading-relaxed">
                My approach combines clean code principles with user-centered design, resulting in applications that are 
                not only technically robust but also intuitive to use. I enjoy solving complex problems and continuously 
                learning new technologies to stay at the forefront of the rapidly evolving tech landscape.
              </p>
            </div>
